...
- [Expo Web canvas rendering](expo-web-canvas-rendering.md) — never use a transformed world container; compute screenX/Y in JS and render each bubble with absolute screen-space left/top.
